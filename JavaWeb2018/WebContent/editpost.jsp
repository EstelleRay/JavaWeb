...
<br>
    ...
    <main role="main" class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                <form class="form-horizontal" method="post" action="EditPostServlet">
                    <div class="form-group">
                        <div class="row">
                            <label for="postTitle" class="col-sm-2 control-label">
                                Title:</label>
                            <div class="col-sm-10">
                                <input type="text" name="postTitle" id="postTitle" class="form-control" value="${post.title }"  required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label for="postContent" class="col-sm-2 control-label">
                                Content:</label>
                            <div class="col-sm-10">
                                <textarea rows="24" name="postContent" id="postContent" class="form-control" 
